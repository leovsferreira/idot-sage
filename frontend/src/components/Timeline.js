      ...
      >
        <button
          ...
          style={{
            ...
            backgroundColor: activeTab === 'timeline' ? '#ffffff' : '#e9ecef',
            color: activeTab === 'timeline' ? '#2c3e50' : '#6c757d',
            fontSize: '11px',
            fontWeight: 'bold',
            cursor: 'pointer',
            transition: 'all 0.2s',
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderRadius: '6px 6px 0 0',
            backgroundColor: activeTab === 'aggregated' ? '#ffffff' : '#e9ecef',
            color: activeTab === 'aggregated' ? '#2c3e50' : '#6c757d',
            fontSize: '11px',
            fontWeight: 'bold',
            cursor: 'pointer',
            transition: 'all 0.2s',
